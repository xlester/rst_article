...
In Table. \ref{Tab:step-error} , we show the error values of the estimated phase-shifts 
using our regularized method and the estimated using the AIA method. These errors are 
...
On the other hand, in Fig. \ref{fig:phase} , we show the recovered phase. Fig. 
\ref{fig:phase}(a) shows the recovered phase using the regularized self-tuning 
demodulation method presented here, while Fig. \ref{fig:phase}(b) shows the 
recovered phase using the AIA method.
In this figure, we can see in this figure that our proposed regularized self-tuning
demodulation method recovers the phase with less error than the AIA method. The errors
shown in Fig. \ref{fig:phase}(a) and Fig. \ref{fig:phase}(b) are calculated as the variance
between the recovered phase map and the true phase map used to generate the interferograms.
\begin{table}[h t p]
	\begin{center}
