...
\begin{figure}[htp]
	...
	\centering
		...
		\end{subfigure}
		\subfigure{\label{fig:phase-a} \includegraphics[scale=0.40]{figures/faseRST.png}}{(a) RST Phase error = 7.0570x10^{-6}. }\\
		\subfigure{\label{fig:phase-b} \includegraphics[scale=0.40]{figures/faseAIA.png}}{(b) AIA Phase error =  0.0608.}
	\end{center}
